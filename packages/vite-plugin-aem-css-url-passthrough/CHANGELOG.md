...
### Removed
- **Breaking:** dropped the redundant `export default aemCssUrlPassthrough` alongside the named export. Only the named export (`import { aemCssUrlPassthrough } from '@aemvite/vite-plugin-aem-css-url-passthrough'`) was ever documented or used internally.
